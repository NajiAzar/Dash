...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home Sliders /</span> Add</h4>
 ...
 @if($errors->any())
    ...
    <div class="card-body">
        <form id="formTestimonial" method="POST" action="{{ route('homesliders.store') }}" enctype="multipart/form-data">
            @csrf
        ...
        <img id="preview" src="#" alt="Image preview" style="display: none; max-width: 100px; max-height: 100px;" />
            ...
            <div class="mt-2">
                <button type="submit" class="btn btn-primary me-2">Save Home Slide</button>
