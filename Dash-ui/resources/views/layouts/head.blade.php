    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="{{ route('showadmin') }}" class="menu-link ">
            ...
            <li class="menu-item">
              <a href="{{ route('homesliders.show') }}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Admin">Homeslider</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('promotionalbanners.show') }}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Admin">Promotional Banner</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route('testimonials.show') }}" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div data-i18n="Admin">Testimonial</div>
              </a>
            </li>
            <li class="menu-item">
...
<script>
    function deleteHomeSlide(homesliderId) {
        if (confirm('Are you sure you want to delete this homeslide?')) {
            fetch(`/homesliders/${homesliderId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
            ...
            .then(data => {
                console.log('Homeslide deleted:', data);
                // Reload the page or update UI as needed
                window.location.reload();
            })
            .catch(error => {
                console.error('Error deleting Homeslide:', error);
                // Handle error as needed
            });
        }
    }
...
<script>
    function deleteBrandLogo(brandlogoId) {
        if (confirm('Are you sure you want to delete this Brand Logo?')) {
            fetch(`/brandlogos/${brandlogoId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                }
            ...
            .then(data => {
                console.log('Brand Logo deleted:', data);
                // Reload the page or update UI as needed
                window.location.reload();
            })
            .catch(error => {
